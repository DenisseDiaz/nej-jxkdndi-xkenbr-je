    ...
    for i in range(1,2):
        while True:
            ...
            if current_page_num<i:
                browser.find_element(By.XPATH,value='/+[@id="primarary_column]/footer/div/div/div/nav/span[2]/a').click()
            elif current_page_num>i:
                browser.find_element(By.XPATH,value='/+[@id="primarary_column]/footer/div/div/div/nav/span[1]/a').click()
            else:
                break
            ## AGREGAR CÓDIGO AQUÍ ##
        ...
        print(f"Extracción de datos de la página {i} completado")
